...
import frc.robot.commands.TimerAvance;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        m_xboxController.y().onTrue(new TimerAvance(m_xrpDrivetrain));
        m_xboxController.a().onTrue(new InstantCommand(() -> {
        }, m_xrpDrivetrain).andThen(new InstantCommand(() -> {
            CommandScheduler.getInstance().schedule(new PIDAvance(m_xrpDrivetrain));
        })));
